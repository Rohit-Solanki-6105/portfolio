...
export const gridItems = [{
    ...
    title: "",
    description: "",
    // description: "Explore my technical, programming, frameworks & languages skills",
    // title: "The Dawn of Innovation",
    // description: "Explore the birth of groundbreaking ideas and inventions.",
    // header: <BackgroundBeams className="h-full w-full" />,
    header: "",
    className: "md:col-span-2 h-* sm:pb-10 md:pb-10",
    // icon: <IconClipboardCopy className="h-4 w-4 text-neutral-500" />,
    icon: <BackgroundBeams />,
  },
  {
    id:2,
    title: "Flexible Timezone Communications",
