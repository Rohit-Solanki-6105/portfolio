...
function Contact() {
    ...
    return (
        <section id='contact' className='flex flex-col lg:flex-row p-4 justify-center items-center min-h-screen text-white w-full max-w-[99vw] relative top-0 left-0 gap-4'>
            ...
            className='flex backdrop-blur-md rounded-lg flex-col gap-4 w-full max-w-md' action={`mailto:${emailList}`} encType='text/plain'>
                <div className='relative group'>
                    <input
                        ...
                        className='w-full p-3 rounded-lg bg-transparent outline-none text-white placeholder-white/70 transition-all duration-300 focus:placeholder-white/90 focus:scale-[1.02] border border-transparent focus:border-white/20'
                        required
                ...
                <div className='relative group'>
                    <textarea
                        name='msg'
                        placeholder='Message'
                        className='w-full p-3 rounded-lg max-w-lg max-h-lg bg-transparent outline-none text-white placeholder-white/70 transition-all duration-300 focus:placeholder-white/90 focus:scale-[1.02] border border-transparent focus:border-white/20'
                        required
                        suppressHydrationWarning
                    />
                    <div className='absolute bottom-0 left-0 w-0 h-0.5 bg-gradient-to-r from-blue-400 to-purple-500 transition-all duration-500 group-focus-within:w-full'></div>
                ...
                suppressHydrationWarning
                >
                    <AnimatedDiv className='px-4 py-3'>
